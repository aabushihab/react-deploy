...
// export default RoomManagementScreen; 12072026 4:00 pm
  ...
  return (
    <>
      <style>{`
        ...
        .room-header .actions button:hover:not(:disabled) {
          transform: scale(1.05);
        }

        .room-header .actions button:disabled {
          opacity: 0.5;
          cursor: not-allowed;
        }

        .room-header .actions button.refresh { background: #4299e1; }
        .room-header .actions button.refresh:hover:not(:disabled) { background: #2b6cb0; }
        .room-header .actions button.export { background: #48bb78; }
        .room-header .actions button.export:hover:not(:disabled) { background: #38a169; }
        ...
        .room-table .action-buttons button:hover:not(:disabled) {
          transform: scale(1.05);
        }

        .room-table .action-buttons .btn-edit { background: #4299e1; }
        .room-table .action-buttons .btn-edit:hover:not(:disabled) { background: #3182ce; }
        .room-table .action-buttons .btn-delete { background: #fc8181; }
        .room-table .action-buttons .btn-delete:hover:not(:disabled) { background: #f56565; }
        ...
        .room-card .card-actions button:hover:not(:disabled) {
          transform: scale(1.05);
        }

        .room-card .card-actions .btn-edit { background: #4299e1; }
        .room-card .card-actions .btn-edit:hover:not(:disabled) { background: #3182ce; }
        .room-card .card-actions .btn-delete { background: #fc8181; }
        .room-card .card-actions .btn-delete:hover:not(:disabled) { background: #f56565; }
        ...
        .room-quick-add .input-row button:hover:not(:disabled) {
          background: #3182ce;
          transform: scale(1.05);
          box-shadow: 0 4px 12px rgba(66, 153, 225, 0.5);
        }
        ...
        .room-modal .modal-actions .btn-primary:hover:not(:disabled) {
          background: #38a169;
          transform: scale(1.05);
        }
        ...
        .room-modal .modal-actions .btn-secondary:hover:not(:disabled) {
          background: #cbd5e0;
          transform: scale(1.05);
        }
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .room-header .status.error {
            color: #e74c3c;
          }

          .room-header .status.loading {
            color: #f39c12;
          }
          ...
          .room-stats .stat-card.active .value {
            color: #4CAF50;
          }

          .room-stats .stat-card.today .value {
            color: #ed8936;
          }

          .room-stats .stat-card .label {
            color: #b0b0b0;
          }
          ...
          .room-tools .search-box input::placeholder {
            color: #666;
          }
          ...
          .room-quick-add .input-row input::placeholder {
            color: #666;
          }
          ...
          .room-modal .validation-msg.success { color: #4CAF50; }
          .room-modal .validation-msg.error { color: #fc8181; }
          ...
          .room-status-bar .status-msg.error {
            color: #e74c3c;
          }

          .room-status-bar .status-msg.loading {
            color: #f39c12;
          }
      ...
      <div className="room-container">
        ...
        <div className="room-stats">
          <div className="stat-card total">
            ...
            <div className="label">{t.stat.totalRooms}</div>
          </div>
          <div className="stat-card active">
            <div className="icon">✅</div>
            <div className="value">{stats.active}</div>
            <div className="label">{t.stat.activeRooms}</div>
          </div>
        ...
        <div className="room-content">
          {loading ? (
            ...
            <div className="room-empty">📭 {t.label.noRooms}</div>
          ) : viewMode === 'table' ? (
            <div className="room-table-wrapper">
              <table className="room-table">
                <thead>
        ...
        {/* Modals */}
        {showAddModal && (
          <div className="room-modal-overlay" onClick={() => {
            setShowAddModal(false);
            setRoomNumber('');
            setSelectedSectionId('');
            setValidationMsg(null);
