...
// export default VisitTrackingScreen;   17072026  11:20 pm
...
//   const refreshVisits = useCallback(async () => {
//     if (currentPatientIdsRef.current.length > 0) {
//       return await fetchVisits(currentPatientIdsRef.current, false);
...
//   // ---------- Update selected visit when filtered visits change ----------
//   useEffect(() => {
//     if (!selectedVisit?.id) return;
...
// export default VisitTrackingScreen;  18072026  8:30 pm 
...
//     let originalAmount = v.originalAmount || 0;
//     let paidAmount = 0;
//     let paymentMethod = 'NEW';  // ✅ CHANGED: Default is now 'NEW' instead of 'FREE'
//     let insurancePaid = false;
//     let insuranceFormId = null;
//     let insuranceCardId = null;
...
//       paymentMethod = 'POS';
//     }
//     // If no payments at all, paymentMethod remains 'NEW'
...
// export default VisitTrackingScreen; 19072026 12:10 am
...
// export default VisitTrackingScreen;  19072026 12:30 am
