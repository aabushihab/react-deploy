...
// export default VisitPayScreen;  19072026 12:30 am
...
//       originalAmountRequired: 'Original amount must be greater than 0',
//       exceedOriginal: 'Total payment cannot exceed original amount',
//       posFieldsRequired: 'All POS fields are required for POS payment',
//       insuranceIdRequired: 'Enter either Card ID or Form ID',
//       insuranceBothIds: 'Enter only Card ID OR Form ID (not both)',
//       acceptNoRequired: 'Insurance Accept Number is required',
//       providerRequired: 'Insurance Provider is required',
//       classRequired: 'Insurance Class is required',
//       paymentFailed: 'Payment failed. Please try again.',
//       networkError: 'Network error. Please check your connection.',
//     },
//     success: {
//       paymentComplete: '✅ Payment completed successfully!',
//       fullPayment: '✅ Full payment completed!',
//       partialPayment: '✅ Partial payment completed!',
//     }
//   };
...
//     setSuccessMessage('');
//     setFieldErrors({});
//   }, [paymentType, cashAmount, posAmount, originalAmount]);
...
//     if (paymentType !== 'FREE' && paymentType !== 'INSURANCE') {
//       if (payingNow <= 0) {
//         errors.paymentAmount = t.error.amountRequired;
//         isValid = false;
//       }
//       if (isTotalExceedingOriginal) {
//         errors.exceedAmount = t.error.exceedOriginal;
//         isValid = false;
//       }
//     }

//     // Validate POS fields
//     if ((paymentType === 'POS' || paymentType === 'CASH + POS') && parseFloat(posAmount) > 0) {
//       if (!terminalId.trim()) {
//         errors.terminalId = t.pleaseEnter + ' ' + t.terminalId;
//         isValid = false;
//       }
//       if (!posNo.trim()) {
//         errors.posNo = t.pleaseEnter + ' ' + t.posNo;
//         isValid = false;
//       }
//       if (!cardType) {
//         errors.cardType = t.select + ' ' + t.cardType;
//         isValid = false;
//       }
//       if (!approvalCode.trim()) {
//         errors.approvalCode = t.pleaseEnter + ' ' + t.approvalCode;
//         isValid = false;
//       }
//     }
...
//       if (!hasCardId && !hasFormId) {
//         errors.insuranceId = t.error.insuranceIdRequired;
//         isValid = false;
//       }
//       if (hasCardId && hasFormId) {
//         errors.insuranceId = t.error.insuranceBothIds;
//         isValid = false;
//       }
//       if (!insuranceAcceptNo.trim()) {
//         errors.insuranceAcceptNo = t.error.acceptNoRequired;
//         isValid = false;
//       }
//       if (!insuranceProvider.trim()) {
//         errors.insuranceProvider = t.error.providerRequired;
//         isValid = false;
//       }
//       if (!insuranceClass) {
//         errors.insuranceClass = t.error.classRequired;
//         isValid = false;
//       }
//     }
...
//       const totalPaid = paymentType === 'FREE' ? 0 : totalPayment;
//       if (totalPaid === originalAmount) {
//         setSuccessMessage(t.success.fullPayment);
//       } else if (totalPaid > 0) {
//         setSuccessMessage(t.success.partialPayment);
//       } else {
//         setSuccessMessage(t.success.paymentComplete);
//       }
...
//                 <label>
//                   {t.original}
//                   <span className="visit-pay-required-badge">*</span>
//                 </label>
//                 <input
//                   type="number"
//                   className={`visit-pay-input ${hasFieldError('originalAmount') ? 'error' : ''}`}
//                   value={originalAmount}
//                   onChange={(e) => setOriginalAmount(parseFloat(e.target.value) || 0)}
//                   placeholder="Enter amount"
//                   min="0.01"
//                   step="0.01"
//                 />
//                 {hasFieldError('originalAmount') && (
//                   <div className="visit-pay-field-error">{getFieldError('originalAmount')}</div>
//                 )}
//                 {remaining > 0 && (
//                   <div className="visit-pay-hint">
//                     💡 Auto-filled with remaining amount ({remaining.toFixed(2)})
...
//           {hasFieldError('paymentAmount') && (
//             <div className="visit-pay-field-error">{getFieldError('paymentAmount')}</div>
//           )}

//           {isTotalExceedingOriginal && (
//             <div className="visit-pay-exceed-error">
//               ⚠️ {t.error.exceedOriginal}
//             </div>
//           )}
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('terminalId') ? 'error' : ''}`}
//                   value={terminalId}
//                   onChange={(e) => setTerminalId(e.target.value)}
//                   placeholder="Enter terminal ID"
//                 />
//                 {hasFieldError('terminalId') && (
//                   <div className="visit-pay-field-error">{getFieldError('terminalId')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('posNo') ? 'error' : ''}`}
//                   value={posNo}
//                   onChange={(e) => setPosNo(e.target.value)}
//                   placeholder="Enter POS number"
//                 />
//                 {hasFieldError('posNo') && (
//                   <div className="visit-pay-field-error">{getFieldError('posNo')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 </label>
//                 <select
//                   className={`visit-pay-input ${hasFieldError('cardType') ? 'error' : ''}`}
//                   value={cardType}
//                   onChange={(e) => setCardType(e.target.value)}
//                 >
//                   <option value="">Select Card Type</option>
...
//                   <div className="visit-pay-field-error">{getFieldError('cardType')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('approvalCode') ? 'error' : ''}`}
//                   value={approvalCode}
//                   onChange={(e) => setApprovalCode(e.target.value)}
//                   placeholder="Enter approval code"
//                 />
//                 {hasFieldError('approvalCode') && (
//                   <div className="visit-pay-field-error">{getFieldError('approvalCode')}</div>
//                 )}
//               </div>
//             </>
//           )}
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('insuranceProvider') ? 'error' : ''}`}
//                   value={insuranceProvider}
//                   onChange={(e) => setInsuranceProvider(e.target.value)}
//                   placeholder="Enter insurance provider"
//                 />
//                 {hasFieldError('insuranceProvider') && (
//                   <div className="visit-pay-field-error">{getFieldError('insuranceProvider')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 </label>
//                 <select
//                   className={`visit-pay-input ${hasFieldError('insuranceClass') ? 'error' : ''}`}
//                   value={insuranceClass}
//                   onChange={(e) => setInsuranceClass(e.target.value)}
//                 >
//                   <option value="">Select Class</option>
...
//                   <option value="C">C</option>
//                 </select>
//                 {hasFieldError('insuranceClass') && (
//                   <div className="visit-pay-field-error">{getFieldError('insuranceClass')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>{t.insuranceType}</label>
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('insuranceAcceptNo') ? 'error' : ''}`}
//                   value={insuranceAcceptNo}
//                   onChange={(e) => setInsuranceAcceptNo(e.target.value)}
//                   placeholder="Enter insurance accept number"
//                 />
//                 {hasFieldError('insuranceAcceptNo') && (
//                   <div className="visit-pay-field-error">{getFieldError('insuranceAcceptNo')}</div>
//                 )}
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 <input
//                   type="text"
//                   className={`visit-pay-input ${hasFieldError('insuranceId') ? 'error' : ''}`}
//                   value={cardId}
//                   onChange={(e) => setCardId(e.target.value)}
//                   placeholder="Enter Card ID OR Form ID"
//                 />
//                 {hasFieldError('insuranceId') && (
//                   <div className="visit-pay-field-error">{getFieldError('insuranceId')}</div>
//                 )}
//                 <div className="visit-pay-hint">
//                   Enter either Card ID or Form ID
//                 </div>
//               </div>
//               <div className="visit-pay-form-group">
//                 <label>
...
//                 )}
//                 <div className="visit-pay-hint">
//                   Enter either Form ID or Card ID
//                 </div>
//               </div>
//             </>
//           )}
...
//           {error && <div className="visit-pay-error">{error}</div>}
//           {successMessage && <div className="visit-pay-success">{successMessage}</div>}
...
// export default VisitPayScreen;  19072026 12:30 am  V2
...
const VisitPayScreen = ({ visit, remaining, loggedUser, onClose, onPaymentComplete }) => {
  const t = {
    ...
    error: {
      ...
      paymentFailed: 'Payment failed. Please try again.',
      networkError: 'Network error. Please check your connection.',
      freeAmountNotZero: 'FREE payment must be 0 amount',
    },
    success: {
      paymentComplete: '✅ Payment completed successfully!',
      fullPayment: '✅ Full payment completed!',
      partialPayment: '✅ Partial payment completed!',
      freePayment: '✅ FREE payment completed!',
    }
  };
  ...
  // Reset payment amounts when switching to FREE
  useEffect(() => {
    if (paymentType === 'FREE') {
      setCashAmount('0');
      setPosAmount('0');
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      // Show success message
      if (paymentType === 'FREE') {
        setSuccessMessage(t.success.freePayment);
      } else {
    ...
    <>
      ...
      <div className="visit-pay-overlay" onClick={onClose}>
        <div className="visit-pay-modal" onClick={(e) => e.stopPropagation()}>
          ...
          {showFreeMessage && (
            <div className="visit-pay-free-message">
              🎉 FREE Payment - No amount will be charged (0.00)
            </div>
          )}
