                ...
                steps: [
                    {
                        id: 'setupIntro',
                        title: '⚙️ System Setup Overview',
                        description: 'Before managing patients, you must configure three core components: Sections, Rooms, and Doctors.',
                        sidebar: '📋 Click "Manage Sections" in the sidebar',
                        details: [
                            'Sections: Medical departments where patients receive care',
                            'Rooms: Physical spaces within sections for patient visits',
                    ...
                    },
                    {
                        id: 'sections',
                        title: '🏛️ Manage Sections',
                        description: 'Sections represent the medical departments in your clinic.',
                        sidebar: '📋 On the "Manage Sections" screen:',
                        details: [
                            'Create new sections for different medical departments',
                            'Edit existing section names and details',
                        ...
                        actions: [
                            '📝 Add Section: Enter name in the Quick Add input',
                            '✏️ Edit Section: Click the "Edit" button next to any section',
                            '🗑️ Delete Section: Click the "Delete" button and confirm',
                            '🔍 Search: Use the search box to find specific sections'
                        ],
                    ...
                    },
                    {
                        id: 'rooms',
                        title: '🛏️ Manage Rooms',
                        description: 'Rooms are physical examination spaces assigned to specific sections.',
                        sidebar: '📋 Click "Manage Rooms" in the sidebar (🚪 icon)',
                        details: [
                            'Create rooms with names and section assignments',
                            'Each room must be assigned to an existing section',
                        ...
                        actions: [
                            '📝 Add Room: Select a section and enter room number',
                            '✏️ Edit Room: Click "Edit" to update room number',
                            '🗑️ Delete Room: Click "Delete" and confirm',
                            '🔍 Search: Find rooms by number, ID, or section name'
                        ],
                    ...
                    },
                    {
                        id: 'doctors',
                        title: '👨‍⚕️ Manage Doctors',
                        description: 'Doctors are the healthcare providers who see patients.',
                        sidebar: '📋 Click "Manage Doctors" in the sidebar (🩺 icon)',
                        details: [
                            'Add doctors with full name and medical specialty',
                            'Generate unique username and password for each doctor',
                    ...
                    },
                    {
                        id: 'setupComplete',
                        title: '✅ Setup Complete',
                        description: 'Your system is now configured with Sections, Rooms, and Doctors.',
                        sidebar: '🎯 Next: Click "Search Patient" in the sidebar',
                        details: [
                            'All sections are created and organized',
                            'Rooms are assigned to their respective sections',
                ...
                steps: [
                    {
                        id: 'search',
                        title: '🔍 Search Patient',
                        description: 'Start by searching for a patient using either Name or Mobile number.',
                        sidebar: '📋 Click "Search Patient" in the sidebar (🔍 icon)',
                        details: [
                            'Select search type: Name or Mobile',
                            'Enter search term (minimum 3 characters)',
                    ...
                    },
                    {
                        id: 'chooseDoctor',
                        title: '👨‍⚕️ Choose Doctor',
                        description: 'After registering an appointment or walk-in visit, you will be prompted to select a doctor.',
                        sidebar: '📋 Select a doctor from the dropdown list',
                        details: [
                            'Select a doctor from the list of available doctors',
                            'View doctor specialties and credentials',
                    ...
                    },
                    {
                        id: 'doctorVisit',
                        title: '🏥 Doctor Visit Closure',
                        description: 'The doctor completes the visit by documenting clinical information and prescribing medications.',
                        sidebar: '📋 From the Visit Tracking screen',
                        details: [
                            'Chief Complaint: Document the primary reason for visit',
                            'Drug Prescriptions: Prescribe medications with dosage',
                    ...
                    },
                    {
                        id: 'payment',
                        title: '💰 Visit Payment Processing',
                        description: 'After the doctor closes the visit, the payment is processed from the Visit Tracking screen.',
                        sidebar: '📋 From the Visit Tracking screen',
                        details: [
                            'Cash: Enter cash amount paid by patient',
                            'POS: Process card payment with terminal details',
            ...
            management: {
                ...
                steps: [
                    ...
                    },
                    {
                        id: 'claimsTracking',
                        title: '📑 Claims Tracking',
                        description: 'Track and settle insurance claims efficiently.',
                        sidebar: '📋 Click "Claims Tracking" in the sidebar (📑 icon)',
                        details: [
                            'View all insurance claims with outstanding balances',
                            'Filter claims by all, unpaid, or by date range',
                    ...
                    },
                    {
                        id: 'visitTracking',
                        title: '📋 Visit Tracking',
                        description: 'Track all patient visits with comprehensive monitoring capabilities.',
                        sidebar: '📋 Click "Visit Tracking" in the sidebar (📝 icon)',
                        details: [
                            'Search visits by patient name or mobile number',
                            'View visit details including patient, doctor, type, status',
                    ...
                    },
                    {
                        id: 'appointments',
                        title: '📅 Appointment Management',
                        description: 'Manage all appointments efficiently with comprehensive scheduling tools.',
                        sidebar: '📋 Click "Appointments" in the sidebar (📅 icon)',
                        details: [
                            'View appointments by date for better organization',
                            'Update appointment notes and details',
                ...
                steps: [
                    {
                        id: 'setupIntro',
                        title: '⚙️ نظرة عامة على إعداد النظام',
                        description: 'قبل إدارة المرضى، يجب تكوين ثلاثة مكونات أساسية: الأقسام والغرف والأطباء.',
                        sidebar: '📋 انقر "إدارة الأقسام" في الشريط الجانبي',
                        details: [
                            'الأقسام: أقسام طبية حيث يتلقى المرضى الرعاية',
                            'الغرف: مساحات فعلية داخل الأقسام لزيارات المرضى',
                    ...
                    },
                    {
                        id: 'sections',
                        title: '🏛️ إدارة الأقسام',
                        description: 'تمثل الأقسام الأقسام الطبية في عيادتك.',
                        sidebar: '📋 في شاشة "إدارة الأقسام":',
                        details: [
                            'إنشاء أقسام جديدة لأقسام طبية مختلفة',
                            'تعديل أسماء وتفاصيل الأقسام الحالية',
                        ...
                        actions: [
                            '📝 إضافة قسم: أدخل الاسم في حقل الإضافة السريعة',
                            '✏️ تعديل قسم: انقر زر "تعديل" بجانب أي قسم',
                            '🗑️ حذف قسم: انقر زر "حذف" وأكد',
                            '🔍 بحث: استخدم مربع البحث للعثور على أقسام محددة'
                        ],
                    ...
                    },
                    {
                        id: 'rooms',
                        title: '🛏️ إدارة الغرف',
                        description: 'الغرف هي مساحات فحص فعليّة مخصصة لأقسام محددة.',
                        sidebar: '📋 انقر "إدارة الغرف" في الشريط الجانبي (أيقونة 🚪)',
                        details: [
                            'إنشاء غرف بأسماء وتعيينات أقسام',
                            'يجب تعيين كل غرفة إلى قسم موجود',
                        ...
                        actions: [
                            '📝 إضافة غرفة: اختر قسمًا وأدخل رقم الغرفة',
                            '✏️ تعديل غرفة: انقر "تعديل" لتحديث رقم الغرفة',
                            '🗑️ حذف غرفة: انقر "حذف" وأكد',
                            '🔍 بحث: ابحث عن الغرف بالرقم أو المعرف أو اسم القسم'
                        ],
                    ...
                    },
                    {
                        id: 'doctors',
                        title: '👨‍⚕️ إدارة الأطباء',
                        description: 'الأطباء هم مقدمو الرعاية الصحية الذين يرون المرضى.',
                        sidebar: '📋 انقر "إدارة الأطباء" في الشريط الجانبي (أيقونة 🩺)',
                        details: [
                            'إضافة أطباء بالاسم الكامل والتخصص الطبي',
                            'توليد اسم مستخدم وكلمة مرور فريدة لكل طبيب',
                    ...
                    },
                    {
                        id: 'setupComplete',
                        title: '✅ اكتمل الإعداد',
                        description: 'تم الآن تكوين نظامك بالأقسام والغرف والأطباء.',
                        sidebar: '🎯 التالي: انقر "بحث عن مريض" في الشريط الجانبي',
                        details: [
                            'تم إنشاء جميع الأقسام وتنظيمها',
                            'تم تعيين الغرف لأقسامها الخاصة',
                ...
                steps: [
                    {
                        id: 'search',
                        title: '🔍 بحث عن مريض',
                        description: 'ابدأ بالبحث عن مريض باستخدام الاسم أو رقم الجوال.',
                        sidebar: '📋 انقر "بحث عن مريض" في الشريط الجانبي (أيقونة 🔍)',
                        details: [
                            'اختر نوع البحث: الاسم أو الجوال',
                            'أدخل مصطلح البحث (3 أحرف على الأقل)',
                    ...
                    },
                    {
                        id: 'chooseDoctor',
                        title: '👨‍⚕️ اختر الطبيب',
                        description: 'بعد تسجيل موعد أو زيارة فورية، سيُطلب منك اختيار طبيب.',
                        sidebar: '📋 اختر طبيباً من القائمة المنسدلة',
                        details: [
                            'اختر طبيباً من قائمة الأطباء المتاحين',
                            'عرض تخصصات الطبيب ومؤهلاته',
                    ...
                    },
                    {
                        id: 'doctorVisit',
                        title: '🏥 إغلاق زيارة الطبيب',
                        description: 'يكمل الطبيب الزيارة بتوثيق المعلومات السريرية ووصف الأدوية.',
                        sidebar: '📋 من شاشة تتبع الزيارات',
                        details: [
                            'الشكوى الرئيسية: توثيق السبب الرئيسي للزيارة',
                            'وصفات الأدوية: وصف الأدوية مع الجرعة',
                    ...
                    },
                    {
                        id: 'payment',
                        title: '💰 معالجة دفع الزيارة',
                        description: 'بعد إغلاق الطبيب للزيارة، يتم معالجة الدفع من شاشة تتبع الزيارات.',
                        sidebar: '📋 من شاشة تتبع الزيارات',
                        details: [
                            'نقداً: إدخال المبلغ النقدي المدفوع من المريض',
                            'POS: معالجة دفع البطاقة مع تفاصيل الجهاز',
                ...
                steps: [
                    {
                        id: 'managementOverview',
                        title: '📊 نظرة عامة على الإدارة الإدارية',
                        description: 'تغطي مرحلة الإدارة أدوات التتبع والمراقبة وإعداد التقارير.',
                        sidebar: '📋 استخدم الشريط الجانبي للتنقل بين وحدات الإدارة',
                        details: [
                            'تتبع المطالبات: إدارة وتسوية مطالبات التأمين',
                            'تتبع الزيارات: مراقبة جميع زيارات المرضى',
                    ...
                    },
                    {
                        id: 'claimsTracking',
                        title: '📑 تتبع المطالبات',
                        description: 'تتبع وتسوية مطالبات التأمين بكفاءة.',
                        sidebar: '📋 انقر "تتبع المطالبات" في الشريط الجانبي (أيقونة 📑)',
                        details: [
                            'عرض جميع مطالبات التأمين مع الأرصدة المعلقة',
                            'تصفية المطالبات حسب الكل، غير المدفوعة، أو حسب نطاق التاريخ',
                    ...
                    },
                    {
                        id: 'visitTracking',
                        title: '📋 تتبع الزيارات',
                        description: 'تتبع جميع زيارات المرضى مع إمكانيات مراقبة شاملة.',
                        sidebar: '📋 انقر "تتبع الزيارات" في الشريط الجانبي (أيقونة 📝)',
                        details: [
                            'البحث عن الزيارات باسم المريض أو رقم الجوال',
                            'عرض تفاصيل الزيارة بما في ذلك المريض والطبيب والنوع والحالة',
                    ...
                    },
                    {
                        id: 'appointments',
                        title: '📅 إدارة المواعيد',
                        description: 'إدارة جميع المواعيد بكفاءة مع أدوات شاملة للجدولة.',
                        sidebar: '📋 انقر "المواعيد" في الشريط الجانبي (أيقونة 📅)',
                        details: [
                            'عرض المواعيد حسب التاريخ لتنظيم أفضل',
                            'تحديث ملاحظات وتفاصيل الموعد',
        ...
        return (
            <>
                <style>{`
                    ...
                    .guide-menu-card:hover .guide-menu-card-button {
                        background: #805ad5;
                ...
                <div className="guide-overlay" dir={isRTL ? 'rtl' : 'ltr'}>
                    <div className="guide-modal">
                        ...
                        <div className="guide-menu-content">
                            <h3 className="guide-menu-title">{t.menu.title}</h3>
                            <p className="guide-menu-subtitle">{t.menu.subtitle}</p>
                            ...
                            <div className="guide-menu-grid">
                                <div 
                                    ...
                                    onClick={() => handleSelectGuide('setup')}
                                >
                                    <div className="guide-menu-card-icon">⚙️</div>
                                    <h4 className="guide-menu-card-title">{t.menu.setup.title}</h4>
                                    <p className="guide-menu-card-description">{t.menu.setup.description}</p>
                                    <div className="guide-menu-card-button">▶ {t.next}</div>
                                </div>
                                ...
                                <div 
                                    ...
                                    onClick={() => handleSelectGuide('patient')}
                                >
                                    <div className="guide-menu-card-icon">👤</div>
                                    <h4 className="guide-menu-card-title">{t.menu.patient.title}</h4>
                                    <p className="guide-menu-card-description">{t.menu.patient.description}</p>
                                    <div className="guide-menu-card-button">▶ {t.next}</div>
                                </div>
                                ...
                                >
                                    <div className="guide-menu-card-icon">📊</div>
                                    <h4 className="guide-menu-card-title">{t.menu.management.title}</h4>
                                    <p className="guide-menu-card-description">{t.menu.management.description}</p>
                                    <div className="guide-menu-card-button">▶ {t.next}</div>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <>
            <style>{`
                ...
                .guide-primary-btn:hover:not(:disabled) {
                    background: #805ad5;
                }
                ...
                .guide-secondary-btn:hover:not(:disabled) {
                    background: #cbd5e0;
                }

                .guide-special-container {
                    display: flex;
                    flex-direction: column;
                    gap: 20px;
                    margin-bottom: 20px;
                ...
                .guide-special-card-icon {
                    font-size: 24px;
                }

                .guide-special-card-title {
                    margin: 0;
                    font-size: 16px;
                    color: #2d3748;
                    font-weight: 600;
                ...
                <div className="guide-modal">
                    <div className="guide-header">
                        <div className="guide-header-left">
                            ...
                            <h2 className="guide-title">{getCurrentTitle()}</h2>
                        </div>
                        <button 
                            onClick={onClose}
                            className="guide-close-btn"
                    ...
                    <div className="guide-journey-map">
                        {steps.map((step, index) => {
                            const isActive = index === currentStep;
                            const isCompleted = index < currentStep;
                            
                            return (
                                <div key={step.id} className="guide-journey-item">
                                    {index > 0 && (
                                        <div 
                                            className="guide-journey-connector"
                                            style={{
                                                background: isCompleted || isActive ? '#9f7aea' : '#e2e8f0'
                                            }}
                                        />
                                    ...
                                    <div 
                                        ...
                                        title={step.title}
                                    >
                                        <span className="guide-journey-icon">
                                            {getStepIcon(step.id)}
                                        </span>
                                    </div>
                    ...
                    <div className="guide-content">
                        ...
                        <div className="guide-sidebar-nav">
                            <div className="guide-sidebar-icon">{currentStepData.sidebarIcon || '📋'}</div>
                            <div className="guide-sidebar-text">
                                <strong>{isRTL ? 'انتقل إلى:' : 'Go to:'}</strong>
                                <span className="guide-sidebar-highlight">{currentStepData.sidebar}</span>
                            </div>
                        </div>

                        <div className="guide-screenshot-container">
                            <span className="guide-screenshot-icon">{currentStepData.screenshot}</span>
                            <div className="guide-screen-badge">
                                {currentStepData.screenName}
                            </div>
                        </div>
                        ...
                        <div className="guide-details-container">
                            <h4 className="guide-details-title">📌 {isRTL ? 'نقاط رئيسية:' : 'Key Points:'}</h4>
                        ...
                        <div className="guide-actions-container">
                            <h4 className="guide-actions-title">🎯 {isRTL ? 'ماذا يمكنك أن تفعل:' : 'What You Can Do:'}</h4>
                            <ul className="guide-list">
                                {currentStepData.actions.map((action, index) => (
                                    <li key={index} className="guide-list-item">
                                        {action}
                    ...
                    <div className="guide-footer">
                        <button
                            onClick={handlePrevious}
                            disabled={currentStep === 0}
                            className="guide-btn guide-secondary-btn"
                        >
                            {t.previous}
                        </button>
                        ...
                        <button
                            onClick={handleNext}
                            className="guide-btn guide-primary-btn"
                        >
                            {currentStep === steps.length - 1 ? t.finish : t.next}
                        </button>
                    </div>
