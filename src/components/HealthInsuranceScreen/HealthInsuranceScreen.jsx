...
// export default HealthInsuranceScreen;  12072026  4:00 pm
  ...
  return (
    <>
      <style>{`
        ...
        .insurance-header .controls button:hover:not(:disabled) {
          transform: scale(1.05);
        }

        .insurance-header .controls button:disabled {
          opacity: 0.5;
          cursor: not-allowed;
        }

        .insurance-header .controls button.get-providers { background: #3498db; }
        .insurance-header .controls button.get-providers:hover:not(:disabled) { background: #2980b9; }
        .insurance-header .controls button.refresh { background: #f39c12; }
        .insurance-header .controls button.refresh:hover:not(:disabled) { background: #e67e22; }
        ...
        .insurance-table .delete-btn:hover:not(:disabled) {
          background: #c0392b;
          transform: scale(1.05);
        }
        ...
        .insurance-add-section .form-grid .button-group button:hover:not(:disabled) {
          transform: scale(1.05);
        }
        ...
        .insurance-add-section .form-grid .button-group .btn-save:hover:not(:disabled) {
          background: #27ae60;
        }
        ...
        .insurance-add-section .form-grid .button-group .btn-clear:hover:not(:disabled) {
          background: #c0392b;
        }
        ...
        .insurance-confirm .actions button:hover {
          transform: scale(1.05);
        }
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .insurance-header .controls .search-box input::placeholder {
            color: #666;
          }
          ...
          .insurance-header .status-badge.error {
            background: #2a1a1a;
            color: #e74c3c;
          }

          .insurance-header .status-badge.loading {
            background: #2a2a1a;
            color: #f39c12;
          }
          ...
          .insurance-add-section .form-grid input::placeholder {
            color: #666;
          }
          ...
          .insurance-status-bar .status-msg.error {
            color: #e74c3c;
          }

          .insurance-status-bar .status-msg.loading {
            color: #f39c12;
          }
        ...
        <div className="insurance-content">
          ...
          <div className="insurance-table-section">
            ...
            {loading && !providers.length ? (
              ...
              <div className="insurance-empty">📭 No providers found</div>
            ) : (
              <div className="insurance-table-wrapper">
                <table className="insurance-table">
                  <thead>
