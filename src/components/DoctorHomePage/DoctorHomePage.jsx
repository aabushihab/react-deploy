...
useEffect(() => {
    ...
    <>
      <style>{`
        ...
        .sidebar-button:hover {
          background: rgba(255, 255, 255, 0.15);
          border-left: 3px solid var(--hover-color, #3498db);
  ...
  min-height: 0; /* Allow flex item to shrink */
        ...
        .filter-action-btn.refresh:hover {
          background: #218838;
        }

        .filter-action-btn.layout {
          background: #17a2b8;
        }

        .filter-action-btn.layout:hover {
          background: #138496;
        }

        .filter-action-btn.sort {
          background: #6c757d;
        }

        .filter-action-btn.sort:hover {
          background: #5a6268;
        }
...
.visit-card {
  ...
  flex-direction: column;
        ...
        .visit-popup-card .visit-card-body {
          flex-wrap: wrap;
        }
        ...
        .visit-popup-actions .btn-close-popup {
          background: #e74c3c;
          color: white;
        }

        .visit-popup-actions .btn-close-popup:hover {
          background: #c0392b;
        }
        ...
        .btn-pdf.patient:hover:not(:disabled) {
          background: #1976D2;
        }
        ...
        .btn-pdf.medical:hover:not(:disabled) {
          background: #7B1FA2;
        }
        ...
        .btn-pdf.drugs:hover:not(:disabled) {
          background: #388E3C;
        }
        ...
        .btn-pdf.procedures:hover:not(:disabled) {
          background: #F57C00;
        }
        ...
        .btn-pdf.full:hover:not(:disabled) {
          background: #0d47a1;
        }
        ...
        .btn-pdf.combined:hover:not(:disabled) {
          background: #004d40;
        }
        ...
        .rtl .sidebar-button:hover {
          border-left: none;
          border-right: 3px solid var(--hover-color, #3498db);
        }
        ...
        .rtl .visit-screen-close-btn {
          right: auto;
          left: 20px;
        }

        .rtl .visit-popup-close {
          right: auto;
          left: 15px;
        }
        ...
        .rtl .details-scrollable {
          padding-right: 0;
          padding-left: 5px;
        }

        .rtl .pdf-buttons-container {
          flex-direction: row-reverse;
        }
